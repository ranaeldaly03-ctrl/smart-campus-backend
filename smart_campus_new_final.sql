...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2026 at 12:51 AM
...
(31, 1, 'a', '', NULL, NULL, 'Assignment', '2026-06-30', 10, NULL, NULL, '2026-05-17 08:56:03', NULL, 0);
...
(14, 31, 7, 'Sat__pro.pdf', 'uploads/1779001901.pdf', '2026-05-17 10:11:41', 1, 10);
...
(8, 5, 1, '2026-01-26', 'Absent', '2026-01-26 17:39:01', 14),
(9, 7, 1, '2026-01-26', 'Absent', '2026-01-26 17:39:01', 14),
(10, 5, 1, '2026-05-14', 'Absent', '2026-05-14 06:19:04', 15),
(11, 7, 1, '2026-05-14', 'Absent', '2026-05-14 06:19:04', 15);
...
(11, 1, 3, '2025-11-30 10:59:16', '2025-12-14 08:57:09', 0, NULL, '458885', 1),
(12, 1, 3, '2025-12-14 08:57:09', '2026-01-19 16:05:28', 0, NULL, '626007', 1),
(13, 1, 3, '2026-01-19 16:05:28', '2026-01-19 16:05:29', 0, NULL, '951209', 1),
(14, 1, 3, '2026-01-26 19:38:56', '2026-01-26 19:39:01', 0, NULL, '904694', 1),
(15, 1, 3, '2026-05-14 09:19:02', '2026-05-14 09:19:04', 0, NULL, '511800', 1);
...
(14, 1, 'Lecture - data', 'uploads/sheet_1.docx', 'lecture', NULL, NULL, '2026-01-20 17:49:50');
...
INSERT INTO `conversations` (`id`, `student_id`, `instructor_id`, `created_at`) VALUES
(1, 7, 3, '2026-05-14 06:29:33'),
(2, 5, 3, '2026-05-14 06:29:44');
...
(1, 'professional ethics', 'Electronics', 3, 14);
...
(2, 1, 5, 5.00, 50.00, '2026-01-20 16:35:11');

-- --------------------------------------------------------

--
-- Table structure for table `gate_policy`
--
...
--
-- Dumping data for table `gate_policy`
--

INSERT INTO `gate_policy` (`id`, `mode`, `updated_at`) VALUES
(1, 'id_only', '2025-12-23 19:03:39');
...
INSERT INTO `messages` (`id`, `conversation_id`, `sender_id`, `message`, `file_path`, `is_read`, `sent_at`) VALUES
(1, 1, 3, 'hi', NULL, 1, '2026-05-14 06:29:39'),
(2, 1, 7, 'hi', NULL, 1, '2026-05-14 06:32:36');
...
INSERT INTO `payments` (`id`, `student_id`, `receipt_number`, `amount`, `term`, `paid_at`, `extra`) VALUES
(1, '2021001', 'RCPT-789', 1500.00, 1, '2025-12-08 13:32:59', NULL);
...
INSERT INTO `student_requests` (`id`, `name`, `email`, `phone`, `department`, `level`, `status`, `created_at`) VALUES
(1, 'ahmed', 'ahmed.fo.21th@gmail.com', '0150109898989', 'electronics', 4, 'pending', '2026-01-19 14:57:27');
...
INSERT INTO `users` (`id`, `name`, `email`, `pass`, `image`, `phone`, `role`, `department`, `level`, `status`) VALUES
(1, 'Admin 1', 'admin1@example.com', '1234', 'uploads/admin.jpg', '011111111', 'Admin', '', '', 'pending'),
(2, 'Student 1', 'student1@example.com', '1234', 'uploads/stu.jpg', '0101111111', 'Student', 'Electronic ', '1', 'pending'),
(3, 'Instructor 1', 'inst1@example.com', '1234', 'uploads/prof.jpg', '012222933', 'Instructor', 'Electronic', '', 'pending'),
(5, 'student 2', 'student2@gmail.com', '1234', 'uploads/stu.jpg', '01222223222', 'Student', 'Electronic', '4', 'active'),
(7, 'rana', 'ranaeldaly03@gmail.com', '1234', 'uploads/rrrr.jpg', '01112036070', 'Student', 'cs', '3', 'active'),
(8, 'Hana Mohamed', 'hanaM99@gmail.com', NULL, NULL, '01212837892', 'Student', 'mechatronics', '3', 'active'),
(9, 'ahmed', 'ahmed.fo.21th@gmail.com', '1234', 'uploads/student_ahmed.fo.21th@gmail.com_goat-messi-golden-boot-7c28kd1zoerik4wj.webp', '0150109898989', 'Student', 'electronics', '4', 'active');
...
ALTER TABLE `conversations`
  ...
  ADD CONSTRAINT `conversations_ibfk_2` FOREIGN KEY (`instructor_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
